...
**Task ID**: `8ae8da5b8ceb`  
**Skill**: `complex_query`  
**Status**: done  
**Created**: 2026-04-23 17:23:07  
**Updated**: 2026-04-23 17:23:07
...
| 步骤 | 描述 | 状态 | 开始时间 | 完成时间 |
|------|------|------|----------|----------|
| Step 1 | 统计每家店铺的优惠券数量，并按数量降序排列，取前5名 | [done] done | 2026-04-23 17:23:07 | 2026-04-23 17:23:07 |
| Step 2 | 获取前5名店铺的名称和优惠券数量，通过shop_id关联tb_shop表 | [done] done | 2026-04-23 17:23:07 | 2026-04-23 17:23:07 |
